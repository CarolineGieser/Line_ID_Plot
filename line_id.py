...
###----REQUIRED INPUT----###
# input datacube	
datafile = '/home/gieser/DATA/AFGL2591_NOEMA/afgl2591_widex_all_contsub_robust0p1_clark-notmerged-pbcor.fits'

# input table with identified transitions
data_tab=np.loadtxt('/home/gieser/Work_Masterthesis/ObservationAnalysis/TransitionProperties.dat',dtype='U',comments='#', delimiter=' ')
